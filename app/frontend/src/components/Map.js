...
import { useMapEvents, MapContainer, ZoomControl, GeoJSON, Tooltip } from 'react-leaflet';
// import { TileLayer } from 'react-leaflet';
import VectorTileLayer from "./VectorTileLayer.ts";
...
export class Map extends Component {
  ...
  setMap = (mapref) => {
    ...
    if (this.props.global.context) {
      ...
      // Set default MaxBounds based on Britain and Ireland tile generation
      const southWest = Leaflet.latLng(DEFAULT_MAXBOUNDS.southWest.lat, DEFAULT_MAXBOUNDS.southWest.lng);
      const northEast = Leaflet.latLng(DEFAULT_MAXBOUNDS.northEast.lat, DEFAULT_MAXBOUNDS.northEast.lng);
  ...
  render() {
    return (
      ...
      {this.props.global.mapinitialized ? (
        ...
        /> */}
        <VectorTileLayer
          attribution='&copy; <a href="https://openmaptiles.org/">OpenMapTiles</a> &copy; <a href="https://openstreetmap.org">OpenStreetMap</a> contributors'
          style={require('../constants/mapstyle.json')}
        />

        {/* <VectorTileLayer
          attribution='&copy; <a href="https://openmaptiles.org/">OpenMapTiles</a> &copy; <a href="https://openstreetmap.org">OpenStreetMap</a> contributors'
          style="https://tiles.positivefarms.org/styles/basic-preview/style.json"
        /> */}
